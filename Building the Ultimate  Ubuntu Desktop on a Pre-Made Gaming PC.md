...
## APPENDIX - Monitor other nodes with `telegraf agent`
...
This allows you to download using your regular desktop and then insert the USB or SD into the device to monitor.
